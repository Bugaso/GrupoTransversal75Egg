		...
		try {
			...
			if (rs.next()) {
				...
				JOptionPane.showMessageDialog(null,
						"El alumno con el ID = " + idAlumno + " no tiene nota en la materia con el ID = " + idMateria);
			}
...
//				+ "AND materia.activo = 1";
	...
	public void borrarInscripcionMateriaAlumno(int idAlumno, int idMateria) {
		...
		try {
			...
			if (exito == 1) {
				...
				JOptionPane.showMessageDialog(null, "No se puede eliminar la inscripción porque el Alumno con el ID = "
						+ idAlumno + " no esta inscripto a la materia con el ID = " + idMateria);
			}
	...
	public void actualizarNota(int idAlumno, int idMateria, double nota) {
		...
		try {
			...
			if (exito == 1) {
				...
				JOptionPane.showMessageDialog(null, "El alumno con el ID = " + idAlumno
						+ " no esta inscripto a la materia con el ID = " + idMateria);
			}
		} catch (SQLException e) {
			JOptionPane.showMessageDialog(null, "Error al acceder a la tabla Inscripción");
		}
	...
	public ArrayList<Alumno> obtenerAlumnosXMateria(int idMateria) {
		...
		String sql = "SELECT a.idAlumno, a.dni, a.apellido, a.nombre, a.fechaNac "
				+ "FROM alumno a JOIN inscripcion i ON (a.idAlumno = i.idAlumno) " + "WHERE i.idMateria = ?";
